  ...
  return (
    <div className="space-y-8 max-w-[1280px] mx-auto">
      <PageHeader
        ...
        badgeIcon={<SettingsIcon className="w-4 h-4 text-cyan-400" />}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3 space-y-2">
          <Card variant="glass" className="p-3 space-y-1">
            {[
        ...
        <div className="lg:col-span-9 space-y-6">
          <Card variant="glass" className="p-8 space-y-6 border-slate-800">
            {saved && (
            ...
            <form onSubmit={handleSave} className="space-y-6">
              {activeSubTab === 'profile' && (
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-white pb-2 border-b border-slate-800">User Profile Settings</h3>
              ...
              {activeSubTab === 'notifications' && (
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-white pb-2 border-b border-slate-800">Alert Notification Rules</h3>
                  <div className="space-y-3 text-xs">
                    <label className="flex items-center justify-between p-3 rounded-xl bg-slate-950 border border-slate-800 text-slate-300">
              ...
              {activeSubTab === 'api' && (
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-white pb-2 border-b border-slate-800">FastAPI Backend Connection</h3>
              ...
              {activeSubTab === 'model' && (
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-white pb-2 border-b border-slate-800">CatBoost Model Hyperparameters</h3>
                  <div className="grid grid-cols-2 gap-4">
              ...
              {activeSubTab === 'security' && (
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-white pb-2 border-b border-slate-800">Security &amp; Enterprise SSO</h3>
                  <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-white">SAML 2.0 Single Sign-On</span>
                      <Badge variant="low">Active</Badge>
                    </div>
                    <p className="text-slate-400">Okta / Azure AD Identity Provider configured for workspace domain.</p>
                  </div>
                </div>
              )}
